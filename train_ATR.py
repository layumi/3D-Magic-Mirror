...
train_dataset = ATRDataset(opt.dataroot, opt.imageSize, train=True, aug=True, threshold = opt.threshold, bg = opt.bg)
train_noaug_dataset = ATRDataset(opt.dataroot, opt.imageSize, train=True, aug=False, threshold = opt.threshold, bg = opt.bg)
test_dataset = ATRDataset(opt.dataroot, opt.imageSize, train=False, aug=False, threshold = opt.threshold, bg = opt.bg)
