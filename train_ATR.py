...
parser.add_argument('--clip', type=float, default=0.05, help='the clip')
...
parser.add_argument('--chamfer', action='store_true', default=False, help='chamfer')
parser.add_argument('--bg', action='store_true', default=False, help='use background')
parser.add_argument('--white', action='store_true', default=False, help='use whitening')
...
parser.add_argument('--flipL1', action='store_true', default=False, help='use')
