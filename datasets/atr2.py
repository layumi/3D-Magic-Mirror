...
class ATR2Dataset(data.Dataset):
    # ratio=2
    def __init__(self, root, image_size, transform=None, ratio = 2, loader=default_loader, train=True, aug=False, return_paths=False, threshold=0.09, bg=False, selected_index = []):
