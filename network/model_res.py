...
class TextureEncoder(nn.Module):
    def __init__(self, nc, nf, nk, num_vertices, ratio=1, makeup=0, droprate = 0, coordconv=False, norm='bn' ):
        ...
        up4 = [Conv2dBlock(128, 64, 3, 1, 1, norm=norm, padding_mode='zeros'), ResBlock(64), nn.Upsample(scale_factor=2)]
        # 128*128*64
        up5 = [Conv2dBlock(64, 32, 3, 1, 1, norm=norm, padding_mode='zeros'), ResBlock(32), nn.Upsample(scale_factor=2)]
        # 256*256
