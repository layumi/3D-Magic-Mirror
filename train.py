...
parser.add_argument('--cross', action='store_true', default=False, help='not update template if point cross 0.')
...
parser.add_argument('--threshold', type=str, default='0.16,0.64', help='parameter')
parser.add_argument('--clean_threshold', type=str, default='0.25,0.49', help='parameter')
...
train_dataset = CUBDataset(opt.dataroot, opt.imageSize, train=True, aug=True, threshold = opt.threshold,  bg = opt.bg)
train_noaug_dataset = CUBDataset(opt.dataroot, opt.imageSize, train=True, aug=False, threshold = opt.clean_threshold, bg = opt.bg)
