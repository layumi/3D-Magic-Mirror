...
parser.add_argument('--smooth', action='store_true', default=True, help='use normalized template')
...
parser.add_argument('--bias_range', type=float, default=0.1, help='parameter bias range')
